# https://levelup.gitconnected.com/creating-an-awesome-interactive-dashboard-using-python-streamlit-9fa427f7754f
...
def load_data():
    data = pd.read_csv('FAOSTAT_data_en_5-4-2024.csv')
...
# C:\python\streamlit\food_security_dashboard.py
# streamlit\food_security_dashboard.py